...
<div class="profile-wrap">
    <div class="profile-header">
        <img class="profile-header-img" src="{{ asset(public/uploads/header/$user->profile_header,true)  }}" alt="">
    
        <img class="profile-show-image" src="{{ asset(public/uploads/profile/$user->profile_img,true) }}" alt="">
