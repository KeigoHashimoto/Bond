...
<div class="profile-wrap">
    <div class="profile-header">
        <img class="profile-header-img" src="/home/blackcat-bear/small_community/public/uploads/header/{{ $user->profile_header }}" alt="">
    
        <img class="profile-show-image" src="/home/blackcat-bear/small_community/public/uploads/profile/{{ $user->profile_img }}" alt="">
