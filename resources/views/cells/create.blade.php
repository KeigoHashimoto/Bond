    ...
    <div class="cell-form">
        ...
        {{ Form::open(['route'=>['cell.store',$table->id]]) }}
            <div class="make-title">
                ...
                {{ Form::text('content1',null,['class'=>'form-control','placeholder' =>'見出し1に対応した内容']) }}
            </div>
            <div class="make-title">
                {{ Form::label('content2','内容２') }}
                {{ Form::text('content2',null,['class'=>'form-control','placeholder' =>'見出し2に対応した内容']) }}
            </div>
            <div class="make-title">
                {{ Form::label('content3','内容３') }}
                {{ Form::text('content3',null,['class'=>'form-control','placeholder' =>'見出し3に対応した内容']) }}
            </div>
            <div class="make-title">
                {{ Form::label('content4','内容４') }}
                {{ Form::text('content4',null,['class'=>'form-control','placeholder' =>'見出し4に対応した内容']) }}
            </div>
            <div class="make-title">
                {{ Form::label('content5','内容５') }}
                {{ Form::text('content5',null,['class'=>'form-control','placeholder' =>'見出し5に対応した内容']) }}
            </div>
