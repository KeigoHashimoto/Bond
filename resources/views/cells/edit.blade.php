        ...
        {{ Form::model($cell,['route'=>['cell.update',$cell->id],'method'=>'put']) }}
            @if(!empty($cell->content1))
                <div class="form-group">
                    ...
                    {{ Form::textarea('content1',null,['class'=>'form-control','placeholder' =>$cell->table->head1."の内容"]) }}
                </div>
            @endif
            ...
            @if(!empty($cell->content2))
                <div class="form-group">
                    ...
                    {{ Form::textarea('content2',null,['class'=>'form-control','placeholder' =>$cell->table->head2."の内容"]) }}
                </div>
            @endif
            ...
            @if(!empty($cell->content3))
                <div class="form-group">
                    ...
                    {{ Form::textarea('content3',null,['class'=>'form-control','placeholder' =>$cell->table->head3."の内容"]) }}
                </div>
            @endif
            ...
            @if(!empty($cell->content4))
                <div class="form-group">
                    ...
                    {{ Form::textarea('content4',null,['class'=>'form-control','placeholder' =>$cell->table->head4."の内容"]) }}
                </div>
            @endif
            ...
            @if(!empty($cell->content5))
                <div class="form-group">
                    ...
                    {{ Form::textarea('content5',null,['class'=>'form-control','placeholder' =>$cell->table->head5."の内容"]) }}
                </div>
            @endif
