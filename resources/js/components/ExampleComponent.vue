                ...
                <div v-if="opinion.board_id === board.id">
                        ...
                        <div class="self-opinion">
                            ...
                            <div v-for="user in users" :key="user.id">
                                <div class="opinion-profile">
                                    <a :href="'/show/' + user.id"><img v-if="user.id === opinion.user_id" :src='"/public/uploads/" + user.profile_img' alt="" class="opinion-profile-img"></a>
                    ...
                    <div v-else>
                        <div class="opinion">
                            ...
                            <div v-for="user in users" :key="user.id">
                                <div class="opinion-profile">
                                    <img v-if="user.id === opinion.user_id" :src='"/public/uploads/" + user.profile_img' alt="" class="opinion-profile-img">
                                    <div v-if="user.id === opinion.user_id" class="opinion-user">{{ user.name }}</div>
                                </div>
                            </div>  
                            <div class="opinion-contents">
